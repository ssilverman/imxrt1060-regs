...
// RTWDOG layout. Comments are from BSD-3-licensed NXP SDK.
//
// See:
...
namespace CS {
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1, 15>       WIN;      // Watchdog Window
    // 0b0..Window mode disabled.
    // 0b1..Window mode enabled.
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1, 14, true> FLG;      // Watchdog Interrupt Flag
    // 0b0..No interrupt occurred.
    // 0b1..An interrupt occurred.
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1, 13>       CMD32EN;  // Enables or disables WDOG support for 32-bit (otherwise 16-bit or 8-bit) refresh/unlock command write words
...
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1, 12>       PRES;     // Watchdog prescaler
...
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 2,  8>       CLK;      // Watchdog Clock
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  7>       EN;       // Watchdog Enable
    // 0b0..Watchdog disabled.
    // 0b1..Watchdog enabled.
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  6>       INT;      // Watchdog Interrupt
...
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  5>       UPDATE;   // Allow updates
...
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 2,  3>       TST;      // Watchdog Test
...
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  2>       DBG;      // Debug Enable
    // 0b0..Watchdog disabled in chip debug mode.
    // 0b1..Watchdog enabled in chip debug mode.
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  1>       WAIT;     // Wait Enable
    // 0b0..Watchdog disabled in chip wait mode.
    // 0b1..Watchdog enabled in chip wait mode.
constexpr RTWDOG_Reg<&RTWDOG_Layout::CS, 1,  0>       STOP;     // Stop Enable
