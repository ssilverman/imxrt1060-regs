...
namespace MCTL {
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 1, 16>       PRGM;       // Programming Mode Select
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 1, 14>       LRUN_CONT;  // Long run count continues between entropy generations
constexpr TRNG_Reg<regs::constify(&TRNG_Layout::MCTL), 1, 13>       TSTOP_OK;   // TRNG_OK_TO_STOP
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 1, 12, true> ERR;        // Read: Error status
...
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 1,  7>       FOR_SCLK;   // Force System Clock
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 1,  6, false, true>       RST_DEF;    // Reset Defaults
...
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 2,  2>       OSC_DIV;    // Oscillator Divide
    // 1/2^value
constexpr TRNG_Reg<&TRNG_Layout::MCTL, 2,  0>       SAMP_MODE;  // Sample Mode
