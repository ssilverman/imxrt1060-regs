...
namespace HPLR {
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1, 18> HAC_L;      // High Assurance Counter Lock When set, prevents any writes to HPHACIVR, HPHACR, and HAC_EN bit of HPCOMR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1, 17> HPSICR_L;   // HP Security Interrupt Control Register Lock When set, prevents any writes to the HPSICR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1, 16> HPSVCR_L;   // HP Security Violation Control Register Lock When set, prevents any writes to the HPSVCR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  9> MKS_SL;     // Master Key Select Soft Lock When set, prevents any writes to the MASTER_KEY_SEL field of the LPMKCR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  8> LPSECR_SL;  // LP Security Events Configuration Register Soft Lock When set, prevents any writes to the LPSECR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  6> LPSVCR_SL;  // LP Security Violation Control Register Soft Lock When set, prevents any writes to the LPSVCR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  5> GPR_SL;     // General Purpose Register Soft Lock When set, prevents any writes to the GPR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  4> MC_SL;      // Monotonic Counter Soft Lock When set, prevents any writes (increments) to the MC Registers and MC_ENV bit
    // 0b0..Write access (increment) is allowed
    // 0b1..Write access (increment) is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  3> LPCALB_SL;  // LP Calibration Soft Lock When set, prevents any writes to the LP Calibration Value (LPCALB_VAL) and LP Calibration Enable (LPCALB_EN)
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  2> SRTC_SL;    // Secure Real Time Counter Soft Lock When set, prevents any writes to the SRTC Registers, SRTC_ENV, and SRTC_INV_EN bits
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  1> ZMK_RSL;    // Zeroizable Master Key Read Soft Lock When set, prevents any software reads to the ZMK Registers and ZMK_ECC_VALUE field of the LPMKCR
    // 0b0..Read access is allowed (only in software Programming mode)
    // 0b1..Read access is not allowed
constexpr SNVS_Reg<&SNVS_Layout::HPLR, 1,  0> ZMK_WSL;    // Zeroizable Master Key Write Soft Lock When set, prevents any writes (software and hardware) to the ZMK registers and the ZMK_HWP, ZMK_VAL, and ZMK_ECC_EN fields of the LPMKCR
    // 0b0..Write access is allowed
    // 0b1..Write access is not allowed
}  // namespace HPLR
...
constexpr SNVS_Reg<&SNVS_Layout::HPCR, 5, 10> HPCALB_VAL;  // HP Calibration Value Defines signed calibration value for the HP Real Time Counter
...
constexpr SNVS_Reg<&SNVS_Layout::HPCR, 1,  8> HPCALB_EN;   // HP Real Time Counter Calibration Enabled Indicates that the time calibration mechanism is enabled.
    // 0b0..HP Timer calibration disabled
    // 0b1..HP Timer calibration enabled
constexpr SNVS_Reg<&SNVS_Layout::HPCR, 4,  4> PI_FREQ;     // Periodic Interrupt Frequency Defines frequency of the periodic interrupt
    // Bit 'value'  of the HPRTCLR is selected as a source of the periodic interrupt
constexpr SNVS_Reg<&SNVS_Layout::HPCR, 1,  3> PI_EN;       // HP Periodic Interrupt Enable The periodic interrupt can be generated only if the HP Real Time Counter is enabled
...
constexpr SNVS_Reg<&SNVS_Layout::HPCR, 1,  1> HPTA_EN;     // HP Time Alarm Enable When set, the time alarm interrupt is generated if the value in the HP Time Alarm Registers is equal to the value of the HP Real Time Counter
...
namespace HPSICR {
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1, 31> LPSVI_EN;  // LP Security Violation Interrupt Enable This bit enables generating of the security interrupt to the host processor upon security violation signal from the LP section
    // 0b0..LP Security Violation Interrupt is Disabled
    // 0b1..LP Security Violation Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  5> SV5_EN;    // Security Violation 5 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 5 security violation
    // 0b0..Security Violation 5 Interrupt is Disabled
    // 0b1..Security Violation 5 Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  4> SV4_EN;    // Security Violation 4 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 4 security violation
    // 0b0..Security Violation 4 Interrupt is Disabled
    // 0b1..Security Violation 4 Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  3> SV3_EN;    // Security Violation 3 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 3 security violation
    // 0b0..Security Violation 3 Interrupt is Disabled
    // 0b1..Security Violation 3 Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  2> SV2_EN;    // Security Violation 2 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 2 security violation
    // 0b0..Security Violation 2 Interrupt is Disabled
    // 0b1..Security Violation 2 Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  1> SV1_EN;    // Security Violation 1 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 1 security violation
    // 0b0..Security Violation 1 Interrupt is Disabled
    // 0b1..Security Violation 1 Interrupt is Enabled
constexpr SNVS_Reg<&SNVS_Layout::HPSICR, 1,  0> SV0_EN;    // Security Violation 0 Interrupt Enable Setting this bit to 1 enables generation of the security interrupt to the host processor upon detection of the Security Violation 0 security violation
...
namespace HPSVCR {
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 2, 30> LPSV_CFG;  // LP Security Violation Configuration This field configures the LP security violation source.
...
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 2,  5> SV5_CFG;   // Security Violation 5 Security Violation Configuration This field configures the Security Violation 5 Security Violation Input
...
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 1,  4> SV4_CFG;   // Security Violation 4 Security Violation Configuration This field configures the Security Violation 4 Security Violation Input
    // 0b0..Security Violation 4 is a non-fatal violation
    // 0b1..Security Violation 4 is a fatal violation
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 1,  3> SV3_CFG;   // Security Violation 3 Security Violation Configuration This field configures the Security Violation 3 Security Violation Input
    // 0b0..Security Violation 3 is a non-fatal violation
    // 0b1..Security Violation 3 is a fatal violation
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 1,  2> SV2_CFG;   // Security Violation 2 Security Violation Configuration This field configures the Security Violation 2 Security Violation Input
    // 0b0..Security Violation 2 is a non-fatal violation
    // 0b1..Security Violation 2 is a fatal violation
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 1,  1> SV1_CFG;   // Security Violation 1 Security Violation Configuration This field configures the Security Violation 1 Security Violation Input
    // 0b0..Security Violation 1 is a non-fatal violation
    // 0b1..Security Violation 1 is a fatal violation
constexpr SNVS_Reg<&SNVS_Layout::HPSVCR, 1,  0> SV0_CFG;   // Security Violation 0 Security Violation Configuration This field configures the Security Violation 0 Security Violation Input
...
namespace LPLR {
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 9> MKS_HL;     // Master Key Select Hard Lock When set, prevents any writes to the MASTER_KEY_SEL field of the LP Master Key Control Register
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 8> LPSECR_HL;  // LP Security Events Configuration Register Hard Lock When set, prevents any writes to the LPSECR
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 6> LPSVCR_HL;  // LP Security Violation Control Register Hard Lock When set, prevents any writes to the LPSVCR
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 5> GPR_HL;     // General Purpose Register Hard Lock When set, prevents any writes to the GPR
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 4> MC_HL;      // Monotonic Counter Hard Lock When set, prevents any writes (increments) to the MC Registers and MC_ENV bit
    // 0b0..Write access (increment) is allowed.
    // 0b1..Write access (increment) is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 3> LPCALB_HL;  // LP Calibration Hard Lock When set, prevents any writes to the LP Calibration Value (LPCALB_VAL) and LP Calibration Enable (LPCALB_EN)
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 2> SRTC_HL;    // Secure Real Time Counter Hard Lock When set, prevents any writes to the SRTC registers, SRTC_ENV, and SRTC_INV_EN bits
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 1> ZMK_RHL;    // Zeroizable Master Key Read Hard Lock When set, prevents any software reads to the ZMK registers and ZMK_ECC_VALUE field of the LPMKCR
    // 0b0..Read access is allowed (only in software programming mode).
    // 0b1..Read access is not allowed.
constexpr SNVS_Reg<&SNVS_Layout::LPLR, 1, 0> ZMK_WHL;    // Zeroizable Master Key Write Hard Lock When set, prevents any writes (software and hardware) to the ZMK registers and ZMK_HWP, ZMK_VAL, and ZMK_ECC_EN fields of the LPMKCR
    // 0b0..Write access is allowed.
    // 0b1..Write access is not allowed.
}  // namespace LPLR
...
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1, 23> PK_OVERRIDE;     // PMIC On Request Override The value written to PK_OVERRIDE will be asserted on output signal snvs_lp_pk_override
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1, 22> PK_EN;           // PMIC On Request Enable The value written to PK_EN will be asserted on output signal snvs_lp_pk_en
...
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 5, 10> LPCALB_VAL;      // LP Calibration Value Defines signed calibration value for SRTC
    // Signed 5-bit value: counts per each 32768 ticks of the counter:
...
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  8> LPCALB_EN;       // LP Calibration Enable When set, enables the SRTC calibration mechanism
    // 0b0..SRTC Time calibration is disabled.
    // 0b1..SRTC Time calibration is enabled.
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  7> LVD_EN;          // Digital Low-Voltage Event Enable By default the detection of a low-voltage event does not cause the pmic_en_b signal to be asserted
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  6> TOP;             // Turn off System Power Asserting this bit causes a signal to be sent to the Power Management IC to turn off the system power
    // 0b0..Leave system power on.
    // 0b1..Turn off system power.
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  5> DP_EN;           // Dumb PMIC Enabled When set, software can control the system power
...
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  3> LPWUI_EN;        // LP Wake-Up Interrupt Enable This interrupt line should be connected to the external pin and is intended to inform the external chip about an SNVS_LP event (MC rollover, SRTC rollover, or time alarm )
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  2> MC_ENV;          // Monotonic Counter Enabled and Valid When set, the MC can be incremented (by write transaction to the LPSMCMR or LPSMCLR)
    // 0b0..MC is disabled or invalid.
    // 0b1..MC is enabled and valid.
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  1> LPTA_EN;         // LP Time Alarm Enable When set, the SNVS functional interrupt is asserted if the LP Time Alarm Register is equal to the 32 MSBs of the secure real time counter
    // 0b0..LP time alarm interrupt is disabled.
    // 0b1..LP time alarm interrupt is enabled.
constexpr SNVS_Reg<&SNVS_Layout::LPCR, 1,  0> SRTC_ENV;        // Secure Real Time Counter Enabled and Valid When set, the SRTC becomes operational
...
namespace LPMKCR {
constexpr SNVS_Reg<regs::constify(&SNVS_Layout::LPMKCR), 9, 7> ZMK_ECC_VALUE;   // Zeroizable Master Key Error Correcting Code Value This field is automatically calculated and set when one is written into ZMK_ECC_EN bit of this register
constexpr SNVS_Reg<&SNVS_Layout::LPMKCR, 1, 4> ZMK_ECC_EN;      // Zeroizable Master Key Error Correcting Code Check Enable Writing one to this field automatically calculates and sets the ZMK ECC value in the ZMK_ECC_VALUE field of this register
    // 0b0..ZMK ECC check is disabled.
    // 0b1..ZMK ECC check is enabled.
constexpr SNVS_Reg<&SNVS_Layout::LPMKCR, 1, 3> ZMK_VAL;         // Zeroizable Master Key Valid When set, the ZMK value can be selected by the master key control block for use by cryptographic modules
    // 0b0..ZMK is not valid.
    // 0b1..ZMK is valid.
constexpr SNVS_Reg<&SNVS_Layout::LPMKCR, 1, 2> ZMK_HWP;         // Zeroizable Master Key hardware Programming mode When set, only the hardware key programming mechanism can set the ZMK and software cannot read it
    // 0b0..ZMK is in the software programming mode.
    // 0b1..ZMK is in the hardware programming mode.
constexpr SNVS_Reg<&SNVS_Layout::LPMKCR, 2, 0> MASTER_KEY_SEL;  // Master Key Select These bits select the SNVS Master Key output when Master Key Select bits are enabled by MKS_EN bit in the HPCOMR
...
namespace LPSVCR {
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 5> SV5_EN;  // Security Violation 5 Enable This bit enables Security Violation 5 Input
    // 0b0..Security Violation 5 is disabled in the LP domain.
    // 0b1..Security Violation 5 is enabled in the LP domain.
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 4> SV4_EN;  // Security Violation 4 Enable This bit enables Security Violation 4 Input
    // 0b0..Security Violation 4 is disabled in the LP domain.
    // 0b1..Security Violation 4 is enabled in the LP domain.
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 3> SV3_EN;  // Security Violation 3 Enable This bit enables Security Violation 3 Input
    // 0b0..Security Violation 3 is disabled in the LP domain.
    // 0b1..Security Violation 3 is enabled in the LP domain.
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 2> SV2_EN;  // Security Violation 2 Enable This bit enables Security Violation 2 Input
    // 0b0..Security Violation 2 is disabled in the LP domain.
    // 0b1..Security Violation 2 is enabled in the LP domain.
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 1> SV1_EN;  // Security Violation 1 Enable This bit enables Security Violation 1 Input
    // 0b0..Security Violation 1 is disabled in the LP domain.
    // 0b1..Security Violation 1 is enabled in the LP domain.
constexpr SNVS_Reg<&SNVS_Layout::LPSVCR, 1, 0> SV0_EN;  // Security Violation 0 Enable This bit enables Security Violation 0 Input
...
namespace LPSECR {
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 1, 28> OSCB;        // Oscillator Bypass When OSCB=1 the osc_bypass signal is asserted
...
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 3, 24> VRC;         // Voltage Reference Configuration These configuration bits are wired as an output of the module.
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 3, 20> HTDC;        // High Temperature Detect Configuration These configuration bits are wired as an output of the module
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 3, 16> LTDC;        // Low Temp Detect Configuration These configuration bits are wired as an output of the module.
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 1, 15> POR_OBSERV;  // Power On Reset (POR) Observability Flop The asynchronous reset input of this flop is connected directly to the output of the POR analog circuitry (external to the SNVS
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 1, 14> PFD_OBSERV;  // System Power Fail Detector (PFD) Observability Flop The asynchronous reset input of this flop is connected directly to the inverted output of the PFD analog circuitry (external to the SNVS block)
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 1,  2> MCR_EN;      // MC Rollover Enable When set, an MC Rollover event generates an LP security violation.
    // 0b0..MC rollover is disabled.
    // 0b1..MC rollover is enabled.
constexpr SNVS_Reg<&SNVS_Layout::LPSECR, 1,  1> SRTCR_EN;    // SRTC Rollover Enable When set, an SRTC rollover event generates an LP security violation.
