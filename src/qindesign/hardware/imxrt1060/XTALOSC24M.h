...
namespace MISC0 {
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1, 31> VID_PLL_PREDIV;                   // PLL source clock predivider; not oscillator-related
    // 0b0..Divide by 1
    // 0b1..Divide by 2
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1, 30> XTAL_24M_PWD;                     // 24 MHz crystal oscillator power-down
constexpr XTALOSC24M_Reg<regs::constify(&XTALOSC24M_Layout::MISC0), 1, 29> RTC_XTAL_SOURCE;  // RTC clock source status
    // 0b0..Internal ring oscillator
    // 0b1..RTC_XTAL
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 3, 26> CLKGATE_DELAY;                    // XTAL 24 MHz clock gate delay
    ...
    // 0b110..6.0 ms
    // 0b111..7.0 ms
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1, 25> CLKGATE_CTRL;                     // XTAL 24 MHz clock gate override
    // Do not change this field during a low-power event; normally, software does not need to modify it.
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1, 16> OSC_XTALOK_EN;                    // 24 MHz crystal oscillator stability detector enable
constexpr XTALOSC24M_Reg<regs::constify(&XTALOSC24M_Layout::MISC0),  1, 15> OSC_XTALOK;      // 24 MHz crystal oscillator stability status
    // This status is generated by a timer and active frequency detection.
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 2, 13> OSC_I;                            // 24 MHz crystal oscillator bias current
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1, 12> DISCON_HIGH_SNVS;                 // VDD_HIGH_IN to VDD_SNVS_IN switch control
    // 0b0..Turn on the switch
    // 0b1..Turn off the switch
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 2, 10> STOP_MODE_CONFIG;                 // Stop mode analog configuration; not oscillator-related
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1,  7> REFTOP_VBGUP;                     // Analog bandgap stability status
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 3,  4> REFTOP_VBGADJ;                    // Analog bandgap voltage adjustment; not oscillator-related
    // 0b000..Nominal VBG
    // 0b001..VBG+0.78%
    // 0b010..VBG+1.56%
    // 0b011..VBG+2.34%
    ...
    // 0b110..VBG-2.34%
    // 0b111..VBG-3.12%
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1,  3> REFTOP_SELFBIASOFF;               // Analog bandgap self-bias disable
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::MISC0, 1,  0> REFTOP_PWD;                       // Analog bandgap reference power-down
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1, 18> GPU_PWRGATE;                         // GPU power gate software mask
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1, 17> MIX_PWRGATE;                         // Display power gate software mask
constexpr XTALOSC24M_Reg<regs::constify(&XTALOSC24M_Layout::LOWPWR_CTRL), 1, 16> XTALOSC_PWRUP_STAT;  // 24 MHz crystal oscillator power-up status
    // 0b0..Not stable
    // 0b1..Stable and ready to use
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 2, 14> XTALOSC_PWRUP_DELAY;                 // 24 MHz crystal oscillator power-up delay
    // 0b00..0.25 ms
    // 0b01..0.5 ms
    // 0b10..1 ms
    // 0b11..2 ms
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1, 13> RCOSC_CG_OVERRIDE;                   // RC oscillator clock gate debug override
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1, 11> DISPLAY_PWRGATE;                     // Display logic power gate software override; not oscillator-related
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1, 10> CPU_PWRGATE;                         // CPU power gate software override; for test purposes only
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  9> L2_PWRGATE;                          // L2 power gate software override; not oscillator-related
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  8> L1_PWRGATE;                          // L1 power gate software override; not oscillator-related
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  7> REFTOP_IBIAS_OFF;                    // Low-power reference-top bias disable; not oscillator-related
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  6> LPBG_TEST;                           // Low-power bandgap test; not oscillator-related
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  5> LPBG_SEL;                            // Bandgap select; not oscillator-related
    // 0b0..Normal power bandgap
    // 0b1..Low power bandgap
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  4> OSC_SEL;                             // 24 MHz clock source select
    // 0b0..Crystal oscillator
    // 0b1..RC oscillator
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::LOWPWR_CTRL, 1,  0> RC_OSC_EN;                           // RC oscillator enable
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 8, 24> RC_OSC_PROG_CUR;  // Current RC oscillator tuning value
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 8,  4> RC_OSC_PROG;      // Programmed RC oscillator tuning value
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 1,  3> INVERT;           // Calculated RC tuning step inversion
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 1,  2> BYPASS;           // Calculated RC tuning value bypass
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 1,  1> ENABLE;           // RC oscillator tuning logic enable
    // Disabling tuning freezes the calculation state.
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG0, 1,  0> START;            // RC oscillator tuning calculation start
}  // namespace OSC_CONFIG0
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG1, 12, 20> COUNT_RC_CUR;  // Current RC oscillator count
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG1, 12,  0> COUNT_RC_TRG;  // Target RC oscillator count
...
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG2,  1, 31> CLK_1M_ERR_FL;  // 1 MHz count error flag
    // The target count was not reached within one 32 kHz clock period, indicating that the target is too high.
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG2,  1, 17> MUX_1M;         // Corrected 1 MHz clock output select
    // 0b0..Output the free-running 1 MHz clock.
    // 0b1..Output the locked 1 MHz clock.
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG2,  1, 16> ENABLE_1M;      // 1 MHz clock output enable
    // 0b0..Disable the 1 MHz clock output.
    // 0b1..Enable the 1 MHz clock output.
constexpr XTALOSC24M_Reg<&XTALOSC24M_Layout::OSC_CONFIG2, 12,  0> COUNT_1M_TRG;   // Target 1 MHz clock count
}  // namespace OSC_CONFIG2
