...
namespace TCR3 {
// CFR not in SAI2
constexpr I2S2_Reg<&I2S_Layout::TCR3, 1, 16> TCE;   // Transmit Channel Enable
    // Different than I2S1
...
namespace RCR3 {
// CFR not in SAI2
constexpr I2S2_Reg<&I2S_Layout::RCR3, 1, 16> RCE;   // Receive Channel Enable
    // Different than I2S1
...
namespace TCR3 {
// CFR not in SAI3
constexpr I2S3_Reg<&I2S_Layout::TCR3, 1, 16> TCE;   // Transmit Channel Enable
    // Different than I2S1
...
namespace RCR3 {
// CFR not in SAI3
constexpr I2S3_Reg<&I2S_Layout::RCR3, 1, 16> RCE;   // Receive Channel Enable
    // Different than I2S1
